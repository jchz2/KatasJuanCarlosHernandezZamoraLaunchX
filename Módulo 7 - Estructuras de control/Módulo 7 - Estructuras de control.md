...
```
user_input = '' "se define la variable para guardar la info del usuario

while user_input.lower() != 'done':   "lo que el usurio escriba convertirlo a minúsculas y sea diferente de la palabra 'done' quiero que:
